...
const TURKISH_UI_WORDS = new Set([
  ...
  'programi', 'şehir', 'universiteler', 've', 'yaz', 'yeni', 'yunanistan', 'üniversite',
...
const LABEL_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/Birleşik Krallık/gi, 'United Kingdom'],
  [/Kuzey İrlanda/gi, 'Northern Ireland'],
  [/Batı Avustralya/gi, 'Western Australia'],
  [/Güney Afrika/gi, 'South Africa'],
  [/Güney Kore/gi, 'South Korea'],
  [/Yeni Zelanda/gi, 'New Zealand'],
  [/İngiltere/gi, 'England'],
  [/İskoçya/gi, 'Scotland'],
  [/\bGaller\b/gi, 'Wales'],
  [/İrlanda/gi, 'Ireland'],
  ...
  [/\bMilano\b/gi, 'Milan'],
  [/Yaz Okulu/gi, 'Summer School'],
  [/Dil Okulu/gi, 'Language School'],
  [/Üniversiteler/gi, 'Universities'],
  [/\bUniversiteler\b/gi, 'Universities'],
  [/Üniversitesi/gi, 'University'],
  [/Üniversite/gi, 'University'],
  [/İngilizce/gi, 'English'],
  [/\bBireysel\b/gi, 'Individual'],
  [/\bGrup\b/gi, 'Group'],
  [/Programı/gi, 'Programme'],
  [/\bve\b/gi, 'and'],
]

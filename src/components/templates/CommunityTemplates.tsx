...
const STORIES_COPY = {
  en: {
    ...
    emptyTitle: 'Every published story starts with permission.',
    emptyBody: 'Happy Education publishes a student experience only after the student has been verified and publication permission has been recorded. This protects the student and keeps every story trustworthy.',
  ...
  tr: {
    ...
    emptyTitle: 'Yayımlanan her hikâye izinle başlar.',
    emptyBody: 'Happy Education bir öğrenci deneyimini yalnızca öğrenci doğrulandıktan ve yayın izni kaydedildikten sonra yayımlar. Bu yaklaşım öğrenciyi korur ve her hikâyenin güvenilir olmasını sağlar.',
